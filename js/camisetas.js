/* URL del archivo JSON donde se almacenan los datos de las camisetas */
const CAMISETAS_URL = "data/camisetasdb.json";

/* 🏷️ Componente que representa una tarjeta individual de camiseta */
function CamisetasCard({ camisetas, onSelectCamiseta }) {
  return (
    <div
...
function App() {
  ...
  React.useEffect(() => {
    fetch(CAMISETAS_URL)
      ...
      .catch((error) => console.error("Error al cargar camisetas:", error));
  }, []);
...
/* Renderiza la app */
ReactDOM.render(<App />, document.getElementById("camisetasgrid"));
